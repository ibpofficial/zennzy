...
6. Keep your answers concise, structured, and action-oriented.`;
  ...
  return createPortal(
    <div className="fixed bottom-6 left-6 z-[9999] font-sans" style={{ position: "fixed" }}>
      {/* Sleek Glassmorphic Launcher Capsule (Rounded Full & Mobile Responsive) */}
      {!isOpen && (
        <button
          onClick={() => setIsOpen(true)}
          className="flex items-center gap-2.5 pl-3 pr-3.5 py-2.5 rounded-full bg-slate-950 dark:bg-slate-900 border border-slate-800 dark:border-slate-850 text-white shadow-[0_8px_24px_rgba(0,0,0,0.2)] hover:shadow-[0_12px_32px_rgba(99,102,241,0.25)] hover:scale-103 active:scale-97 transition-all duration-300 relative group cursor-pointer backdrop-blur-md"
        ...
        >
          ...
          <div className="flex items-center justify-center w-6.5 h-6.5 rounded-lg bg-gradient-to-tr from-primary-600 to-indigo-650 shadow-sm shrink-0">
